...
_4=_3.new_quote(this);
if($(this).hasClass("qod_candidate")){
_3.update_db(_4.id,{qod:true},"q");
}
...
},new_quote:function(_5){
var q;
q=new Quote(_5);
return q;
},_build_sections:function(_7){
var _8;
_8=this;
if($(".section, .sub_section",_7).length>0){
$(".section, .sub_section",_7).each(function(){
_8.create_new_section(this);
_8.publish("progressbar_update",{val:1});
});
}
},create_new_section:function(_9){
var _a,_b,s;
_b=typeof _9==="string"?_9:$(_9).text();
_a=this.find_in_db(_b,"s");
if(!_a){
s=new Section(_9);
}
},insert_new_quote:function(id,_e,_f,_10){
var _11,_12,_13;
_11=this;
_13=_14(id,_e);
if(_13.length===0){
this.db.update(id,_f,_10);
this.publish("quote_inserted",{id:id});
}else{
this.publish("warning",{msg:"Missing "+_13.join(", ")});
}
function _14(id,_16){
var q,_18,_19;
q=_11.find_in_db(id,"q");
...
},update_q_section:function(id,_22,_23){
...
if(Quote.need_section(_22)){
var _24,q,_26;
_24=new Object();
_24.section=_23.section;
q=this.find_in_db(id,"q");
function _27(_28){
var _29;
_29=["trans","purport","text"];
if(!q[_28]){
$.each(_29,function(i,sec){
if(sec===_28){
return;
}
if(q[sec]){
...
if(_23.section!=="Translation and Purport"){
if(_23.section.match(/trans/i)){
_27("trans");
}else{
_27("purport");
}
...
this.publish("warning",{msg:"You have chosen \"Translation and Purport\" but you are missing the "+_26+" text."});
}
this.update_db(id,_24,"q");
}else{
this.publish("warning",{msg:"This quote does not require a section"});
}
},process_verse:function(_2e){
var _2f,_30,_31,_32,_33;
_2f=this.find_in_db(_2e.quote,"q");
_33={};
_33["verses"]=_2f.verses;
function _34(all){
var a=all.split("\n");
...
_30=_2f.verses[_2e.verse];
_33[_32]=_31.replace(_30,_34);
}
_33.verses[_2e.verse]="done";
this.update_db(_2f.id,_33,"q");
},update_heading:function(_37){
if(!_37&&window.console){
console.log("Missing params in Compilation.update_heading");
}
var _38,_39;
_39={};
if(_37.action==="append"){
_38=this.find_in_db(_37.id,"q");
_39.heading=_38.heading?_38.heading+" "+_37.heading:_37.heading;
}
if(_37.action==="set"){
_39.heading=_37.heading;
_39.heading=_39.heading.replace(/^[a-z]/,_3a);
_39.heading=_39.heading.replace(/,$/,".");
_39.heading=_39.heading.replace(/[^.?!"]$/,_3b);
}
if(_37.action==="new"){
_39.heading=" ";
}
function _3a(_3c){
return _3c.toUpperCase();
};
function _3b(_3d){
return _3d+".";
};
this.update_db(_37.id,_39,"q");
},update_db:function(id,_3f,_40){
if(!id||!_3f||!_40){
if(window.console){
console.log("Missing parameters in udpate_db");
}
}
this.db.update(id,_3f,_40);
var q=this.find_in_db(id,"q");
Quote.update_section(q);
this.publish("updated",{id:id,quote:q});
},del_from_db:function(id,_43){
this.db.del(id,_43);
if(_43==="q"){
this.publish("deleted",{id:id});
}
},find_in_db:function(ref,_45){
if(!ref||!_45){
if(window.console){
console.error("Compilation#find_in_db: Missing parameters! ref: "+ref+", type: "+_45);
}
return;
}
if(_45==="s"){
...
_48.publish("section_checked",{id:id,result:"good"});
}
function _4b(){
_48.publish("section_checked",{id:id,result:"bad"});
_48.publish("warning",{warning:"You have set \""+q.section+"\" as your section but this quote appears to be missing the corresponding text(s)!"});
};
},undo:function(id,_4d){
this.db.undo(id,_4d);
this.publish("undone",{id:id});
},db:{sections:new Object(),undo_sections:new Object(),sec_count:new Object(),quotes:new Object(),undo_quotes:new Object(),quote_count:new Object(),add:function(obj,id,_50){
var _51;
_51=this._where(_50);
if(_50==="q"){
...
this[_51][id]=obj;
},find:function(id,_53){
var _54;
_54=this._where(_53);
for(var obj in this[_54]){
if(obj==id){
return this[_54][obj];
}
}
return false;
},update:function(id,_57,_58){
var _59,_5a;
_59=this._where(_58);
this._backup(id,_59);
from=_57;
...
CompileController=MVC.Controller.extend("compilation",{progress_val:0,loading:false,saving:false,compile_tools:"",compile_tools_menu_hover_options:{sensitivity:2,interval:300,over:function(){
...
if(e.keyCode!==_6&&e.keyCode!==_7){
return;
}
e.stopImmediatePropagation();
e.preventDefault();
CompileController.show_compile_tools();
_8=$("div#compilation > div#compile_tools");
_9=_8.tabs("option","selected");
if(e.keyCode===_7){
if(_9!==0){
_8.tabs("select",0);
}
...
},fix_z_indexes:function(_b){
$("#p-logo, #p-cactions").css("z-index",_b?1:"");
},},{load:function(_c){
this._loading("init");
var _d,_e;
_d=this;
_d.update_progressbar(10);
_e=$("div#bodyContent > form#editform > textarea#wpTextbox1").val();
if(_e!==""&&_e.indexOf("<div id=\"compilation\">")===-1){
if(window.console){
...
_e="<div id=\"compilation\"></div>";
}
this.render({after:"wikiPreview",action:"compilation"});
_d.update_progressbar(10);
Facts.build(_e);
_d.update_progressbar(10);
Compilation.build(_e);
},"div#compile_tools span#compile_tools_hide click":function(_f){
CompileController.hide_compile_tools();
},"div#transparent_background click":function(){
CompileController.hide_compile_tools();
},"div#compile_tools_menu p#compile_tools_toggle click":function(_10){
var pos=_10.event.pageY-50;
this.toggle_compile_tools(pos);
},"div#compile_tools_menu p#compile_tools_save click":function(_12){
_12.event.kill();
this.save();
},"div#compile_tools div#compile_form .ui-state-default mouseover":function(_13){
$(_13.element).addClass("ui-state-hover");
},"div#compile_tools #compile_form .ui-state-default mouseout":function(_14){
$(_14.element).removeClass("ui-state-hover");
...
$("div#bodyContent > div#compilation > div#compile_tools_menu").hoverIntent(_17.Class.compile_tools_menu_hover_options);
setTimeout(_17.Class.hide_tools_menu,5000);
...
},_render_section:function(_18){
var _19;
this.section=_18;
_19=this.section.parent;
if(window.console){
console.assert(_19);
}
if(_19!=="compilation"&&$("#"+_19).length!==1){
this._render_section(Compilation.find_in_db(_19,"s"));
}
if(window.console){
console.info("CompileController#_render_section: rendering "+this.section.id+" to "+_19);
}
this.render({bottom:_19,action:"sections"});
this.sort_section(_19);
},clean_up:function(){
this._sort_sections();
this._remove_empty_secs();
this._sort_quotes();
},sort_section:function(_1a){
if($("div#compilation > div#"+_1a).children().length>1){
$("div#compilation > div#"+_1a).children("div.section, div.sub_section").tsort({attr:"sec_index"});
}
},_sort_sections:function(){
var _1b=$("div#compilation > div.section");
var _1c=$("div#compilation > div.section > div.sub_section");
$(_1b).tsort({attr:"sec_index"});
$(_1c).tsort({attr:"sec_index"});
},_remove_empty_secs:function(){
var _1d,id;
_1d=[];
_1f($("div#compilation > div.section > div.sub_section"));
_1f($("div#compilation > div.section"));
function _1f(_20){
$(_20).each(function(){
id=$(this).attr("id");
$.inArray(id,_1d)>-1?_21(this):_1d.push(id);
...
function _21(_22){
if(window.console){
console.info("CompilationController#_remove_empty_secs: removing duplicate or empty section: "+$(_22).attr("id"));
}
$(_22).remove();
Compilation.del_from_db($(_22).attr("id"),"s");
};
...
_26();
function _27(_28){
_25=wgServer+wgScriptPath+"/api.php?action=login&format=json&"+_28;
$.ajax({type:"POST",url:_25,dataType:"json",success:function(_29){
if(window.console){
console.dir(_29);
}
$("body > div#progressbar").progressbar("enable");
_24.save();
},error:function(_2a,_2b,_2c){
if(window.console){
...
_27($("#login_form form").serialize());
};
function _26(){
if(!$("#login_form").hasClass("ui-dialog-content")){
$("#login_form").dialog({modal:true,title:"Log-in to save",modal:true,open:function(_2e,ui){
$("#login_form #lgpassword").focus();
},buttons:{"Login":_2d}}).keydown(function(e){
if(e.keyCode===13){
_2d();
}
});
...
var _31;
_31=this;
_31.publish("progressbar",{text:"Saving..."});
_31.check_user_loggedin();
},check_internet_connection:function(){
var _32,_33,_34;
_32=this;
_33=false;
_34=new XMLHttpRequest();
_34.onreadystatechange=_35;
_34.open("HEAD","http://www.google.com",true);
_34.send(null);
setTimeout(function(){
if(_34.readyState==4&&!_33){
_36();
}
},3000);
function _35(){
if(window.console){
console.log(_34.readyState);
}
if(_34.readyState==4){
if(_34.statusText&&_34.statusText!=""){
if(window.console){
console.log("Connected");
}
_33=true;
_32.publish("progressbar_hide");
_32.publish("connection_error",{ajax:_34,msg:"Vaniquotes server is unreachable, please wait a minute and try again."});
}
}
};
function _36(){
_32.publish("progressbar_hide");
_32.publish("connection_error",{ajax:_34,msg:"You appear to be offline! Check your internet connection and try again."});
};
},check_user_loggedin:function(){
var _37,_38;
_37=this;
_38=false;
sajax_do_call("isUserLoggedIn",[],_39);
setTimeout(function(){
if(!_38){
if(navigator.platform=="MacIntel"){
_37.check_internet_connection();
}else{
_37.publish("progressbar_hide");
_37.publish("connection_error",{ajax:{},msg:"Vaniquotes server is unreachable, please wait a minute and try to save again."});
}
}
},3000);
function _39(_3a){
_38=true;
if(_3a.status!=200){
_37.publish("connection_error",{ajax:_3a,msg:"Vaniquotes server is unreachable, please wait a minute and try to save again."});
}else{
if(window.console){
console.log("Success: "+_3a.responseText);
}
}
if(_3a.responseText==="no"){
_37.relogin();
}else{
_37._check_before_save();
}
};
},_check_before_save:function(){
var _3b;
_3b=this;
_3b.update_progressbar();
function _3c(){
_3b.publish("progressbar_hide");
};
...
var _3d,_3e,_3f,_40,_41,_42,_43,upb,_45;
_3d=this;
this.Class.saving=true;
upb=_3d.update_progressbar;
_42=$("<div id=\"compilation\"></div>");
_3d.update_progressbar();
_3e=Facts.save();
_3d.update_progressbar();
$("<div id=\"facts\">"+_3e+"</div>").appendTo(_42);
_3d.update_progressbar();
_41=$(".quote").not(".deleted_quote").clone();
_3d.update_progressbar();
_41.each(function(){
var q,p,l,lt,_4a;
q=$(this);
...
q.removeAttr("style");
_3d.update_progressbar(1);
});
_41.appendTo(_42);
_3f=$(".section").clone();
_40=$(".sub_section").clone();
_40.each(_4b);
_3f.each(_4b);
function _4b(){
var s,l,h,id,_50;
...
id=_50.replace(/ /g,"_");
s.empty();
$("<"+h+">"+_50+"</"+h+"></div>").appendTo(s);
$("div[parent=\""+id+"\"]:first",_42).before(s);
_3d.update_progressbar();
};
_43=_42.wrap("<div></div>").parent("div").html().replace(/^\s+/mg,"").replace(/<\/span>\n/g,"</span>").replace(/(<div[^>]+?(?:id="facts"|class="(?:quote|section|sub_section)"))/g,"\n$1").replace(/([^\n])<\/div>/g,"$1\n</div>");
_3d.update_progressbar();
$("#wpTextbox1").val(_43);
_3d.update_progressbar();
if(window.console){
...
var _53,_54;
_53=this;
_54=CompileController.compile_tools.is(":visible");
this.warning=msg;
CompileController.fix_z_indexes(true);
...
$(this).unbind("click",_55);
$(this).unbind("keydown",_55);
};
...
var _59;
_59=this;
_59.Class.progress_val=val===undefined?_59.Class.progress_val+3:_59.Class.progress_val+val;
$("body > div#progressbar").progressbar("value",_59.Class.progress_val);
if(window.console){
}
},block_background:function(_5a){
var _5b;
_5b=this;
if(window.console){
console.info("In Compilation_controller.block_background with action: "+_5a);
}
if(_5a){
CompileController.fix_z_indexes(true);
...
},connection_error:function(_5c){
var _5d;
_5d=this;
if(window.console){
console.log("Ajax error: "+_5c.ajax.text+" : "+_5c.ajax.error);
}
window.alert(_5c.msg);
},enable_keybinding_save:function(){
var _5e;
_5e=this;
$(document).bind("keydown",function(e){
var _60=83;
if(e.ctrlKey&&e.keyCode===_60){
e.stopPropagation();
_5e.save();
}
});
...
var _61;
_61=this;
_61.update_progressbar(20);
this.clean_up();
this._loading("end");
},"quote.found_reference subscribe":function(_62){
...
},"compilation.quote_inserted subscribe":function(_63){
CompileController.show_compile_tools();
},"section.created subscribe":function(_64){
Compilation.add_to_db(_64,_64.id,_64.parent,"s");
this._render_section(_64);
},"hide_compile_tools subscribe":function(){
CompileController.hide_compile_tools();
},"info subscribe":function(_65){
if(window.console){
console.info("Info: "+_65.msg);
}
this.info(_65.msg);
},"warning subscribe":function(_66){
if(window.console){
console.log("Warning: "+_66.msg);
}
this.warning(_66.msg);
},"quote.warning subscribe":function(_67){
if(window.console){
console.log("Warning: "+_67.msg);
}
this.warning(_67.msg);
},"facts.warning subscribe":function(_68){
if(window.console){
console.log("Warning: "+_68.msg);
}
this.warning(_68.msg);
},"compilation.warning subscribe":function(_69){
if(window.console){
console.log("Warning: "+_69.msg);
}
this.warning(_69.msg);
},"section.warning subscribe":function(_6a){
if(window.console){
console.log("Warning: "+_6a.msg);
}
this.warning(_6a.msg);
},"report_error subscribe":function(_6b){
if(window.console){
console.log("Reporting error to developers/maintainers: "+_6b.msg);
}
this.report_error(_6b.msg);
},"connection_error subscribe":function(_6c){
this.connection_error(_6c);
},"quote.connection_error subscribe":function(_6d){
this.connection_error(_6d);
},"progressbar subscribe":function(_6e){
var _6f;
_6f=this;
_6f.block_background(true);
if(window.console){
...
$("body > div#progressbar > div").text(_6e.text);
},"progressbar_hide subscribe":function(_70){
if(!$("body > div#progressbar").hasClass("ui-progressbar")){
return;
}
var _71;
_71=this;
...
_71.block_background(false);
_71.Class.progress_val=0;
},"progressbar_update subscribe":function(_72){
if(window.console){
console.count("Progressbar_update subscribe");
}
this.update_progressbar(_72.val);
},"compilation.progressbar_update subscribe":function(_73){
if(window.console){
console.count("Progressbar_update subscribe");
}
this.update_progressbar(_73.val);
},"quote.check_internet_connection subscribe":function(_74){
this.check_internet_connection(_74);
}});
;
include.set_path('controllers');
QuotesController=MVC.Controller.extend("quotes",{currently_editing:false,focused_textarea:false,current_quote:"",key:{escape:27,heading:72,section:83,trans:84,purport:80,trans_purport:78,edit_quote:81,insert:73,heading_create:65,heading_edit:77,heading_set:69,heading_append:68,heading_new:78,verse_select:86,enter:13},enable_keybindings:function(_1){
...
_7=$("div#alert_tip").is(":visible")?$("div.q_menu > div.q_tips > div#alert_tip",q):$("div.q_menu > div.q_tips",q);
k=e.keyCode;
...
$.each(QuotesController.key,function(_8,_9){
if(_9===e.keyCode){
$("input[id*=\""+_8+"\"]",_7).click();
return;
}
});
},enable_edit_keybindings:function(_a){
QuotesController.disable_keybindings();
$(_a).bind("keydown",{q:_a},QuotesController.edit_view_keybindings_event);
},disable_edit_keybindings:function(_b){
$(_b).unbind("keydown",QuotesController.edit_view_keybindings_event);
QuotesController.enable_keybindings(_b);
...
if(e.shiftKey&&e.keyCode===QuotesController.key["enter"]){
$("div#edit_buttons > input#Update_quote",q).click();
}
},},{mouseover:function(_d){
_d.event.kill();
QuotesController.current_quote=_d.element;
if(!$(_d.element).hasClass("edit_quote")){
QuotesController.enable_keybindings(this);
}
},mouseleave:function(_e){
_e.event.kill();
QuotesController.disable_keybindings();
this.cancel_tip(_e.element);
},dblclick:function(_f){
...
this.render_quote({elem:_f.element,view:"edit"});
},"div#edit_buttons input#Update_quote click":function(_10){
var _11;
_11=$(_10.element).parents(".quote");
_10.event.kill();
this._event_resp({elem:_11,action:"update"});
},"div#edit_buttons input#Cancel_quote click":function(_12){
var _13;
_13=$(_12.element).parents(".quote");
_12.event.kill();
this._event_resp({elem:_13,action:"cancel"});
},"div#link_text click":function(_14){
_14.event.kill();
$(_14.element).parents("div.edit_quote").children("div#fix_link").toggle().children("input#fix_link_input").focus();
},"div.edit_quote #prabhupada_icon click":function(_15){
var _16;
_15.event.kill();
_16=$(_15.element).parents(".quote").children("#text")[0];
if(_16.value.length===_16.selectionStart){
this.publish("warning",{msg:"You must place the cursor in the text where Prabhup&#257;da is the speaker"});
return;
}
this.insert_prabhupada_speaker(_16);
},"div#diacritics span#diacritics_toggle click":function(_17){
$(_17.element).siblings("p").toggle();
},"div#diacritics p a click":function(_18){
var _19,_1a;
_18.event.kill();
_19=this.Class.focused_textarea;
if(!_19){
this.publish("warning",{msg:"You must place the cursor in the text where you wish to insert the diacritic character"});
return;
}
diacritc=_18.element.innerHTML;
this.insert_diacritic(_19,diacritc);
},"textarea focus":function(_1b){
this.Class.focused_textarea=_1b.element;
},"div.undo_quote click":function(_1c){
if(_1c.element.has_class("edit_quote")!==undefined){
return;
}
var _1d;
_1c.event.kill();
_1d=$(_1c.element).parents("div.quote");
this.undo(_1d);
},"div.del_quote click":function(_1e){
var _1f;
_1e.event.kill();
_1f=$(_1e.element).parents("div.quote");
this.delete_quote(_1f);
},"div.candidate_quote click":function(_20){
var _21;
_20.event.kill();
$(_20.element).hasClass("ui-state-error")?$(_20.element).removeClass("ui-state-error"):$(_20.element).addClass("ui-state-error");
},".deleted_quote_msg .undo_del_quote click":function(_22){
var _23;
_22.event.kill();
_23=$(_22.element).parents("div.quote");
this.undo(_23);
},"div.text mouseup":function(_24){
if(window.getSelection().toString()===""){
return;
}
if(_24.element.has_class("edit_quote")!==undefined){
return;
}
_24.event.kill();
var _25;
_25=_24.element;
this.check_selection(_25);
},"div.q_menu div.q_tips input.tips click":function(_26){
var _27;
_27=_26.element;
_26.event.kill();
this.tips_handler(_27);
},"div.q_menu div.q_tips div#alert_tip input.alert_tip_heading_or_verse click":function(_28){
var id,_2a;
_28.event.kill();
id=_28.element.id;
_2a=$(_28.element).parents("div.quote");
if(id==="heading_select"){
if(_2a.children(".heading").length){
this.tip_alert({elem:_2a,type:"heading"});
}else{
this._do_heading(_2a,"heading_set");
}
}else{
this.process_verse($(_2a).attr("id"));
}
},"div.q_menu div.q_tips div#alert_tip input.alert_tip_heading_set click":function(_2b){
var id,_2d;
_2b.event.kill();
id=_2b.element.id;
_2d=$(_2b.element).parents("div.quote");
if(id==="heading_new"){
Compilation.update_heading({id:_2d.attr("id"),heading:" ",action:"new"});
$("#heading",_2d).focus();
}
if(id==="heading_edit"){
if(this.Class.currently_editing){
...
if(_2d.children(".heading").length===0){
Compilation.update_heading({id:_2d.attr("id"),heading:" ",action:"new"});
}else{
this.render_quote({elem:_2d,view:"edit"});
}
$("#heading",_2d).focus().select();
}
if(id==="heading_create"){
this.tip_alert({elem:_2d,type:"heading"});
}
if(id==="heading_set"||id==="heading_append"){
this._do_heading(_2d,id);
}
},"div.q_menu div.q_tips div#alert_tip input click":function(_2e){
var _2f,_30;
_2e.event.kill();
_30=_2e.element;
_2f=_30.id;
if(window.console){
console.log(_30+" with "+_2f);
}
this._do_section(_30,_2f);
},".ui-state-default mouseover":function(_31){
$(_31.element).addClass("ui-state-hover");
},".ui-state-default mouseout":function(_32){
$(_32.element).removeClass("ui-state-hover");
},".ui-state-default mousedown":function(_33){
$(_33.element).addClass("ui-state-active");
},".ui-state-default mouseup":function(_34){
$(_34.element).removeClass("ui-state-active");
},render_quote:function(_35){
var id,_37,_38;
_37=_35["elem"];
_37.id?id=_37.id:id=$(_37).attr("id");
if($("#"+id).length!==1){
this._append_quote(_37);
}
if(_35["view"]==="view"){
_38="quote";
...
if(_35["view"]==="edit"){
_38="quote_edit";
this.Class.currently_editing={elem:_37,view:"view"};
$("#"+id).addClass("edit_quote");
$(document).unbind("click");
CompileController.disable_keybindings();
QuotesController.enable_edit_keybindings(_37);
}else{
if(_35["view"]==="delete"){
_38="delete";
...
_38==="delete"?this.deleted=Compilation.db.find(id,"d"):this.quote=Compilation.db.find(id,"q");
if(_38==="quote"&&this.quote.section==="Translation and Purport"&&(this.quote.trans===" "||this.quote.purport===" ")){
this.render_quote({elem:_37,view:"edit"});
return;
}
if(_38==="quote"&&this.quote.heading===" "){
this.render_quote({elem:_37,view:"edit"});
return;
}
if(_35["view"]==="edit"){
...
},edit_quote:function(_39){
if(this.Class.currently_editing){
this.render_quote(this.Class.currently_editing);
}
this.render_quote({elem:_39,view:"edit"});
$.scrollTo(_39,"slow",{easing:"easeOutExpo",offset:-50});
},_event_resp:function(_3a){
var _3b,id,_3d;
_3d=this;
_3b=$(_3a.elem);
id=_3b.attr("id");
action=_3a.action;
if(_3b.children("#trans, #purport").length===2&&action==="cancel"){
if(/^\s+$/.test(_3b.children("#trans").val())||/^\s+$/.test(_3b.children("#purport").val())){
action="update";
}
}
if(_3b.children("#heading").length===1&&action==="cancel"){
if(/^\s+$/.test(_3b.children("#heading").val())){
action="update";
}
}
if(action==="update"){
...
_3b.fadeOut("fast");
this.render_quote({elem:_3b,view:"view"});
_3b.fadeIn("slow");
if(!_3b.hasClass("building_quote")){
this._transition_hilite(_3b,"#FFFEC6",2);
}
}
QuotesController.disable_edit_keybindings(_3a.elem);
},check_selection:function(_3e){
var q=$(_3e).parents(".quote");
if($("div#alert_tip",q).is(":visible")){
return;
}
var _40,_41,_42,_43;
_40=this;
_41=$.trim(window.getSelection().toString());
if(_41===""){
if($("div#alert_tip").is(":visible")){
this.cancel_tip(_42);
}
...
_42=$(_3e).parents("div.quote");
this.tip_alert({elem:_42,type:"heading_or_verse"});
},delete_quote:function(_44){
var id,_46;
_46=this;
id=$(_44).attr("id");
...
_48=this;
id=$(_47).attr("id");
$(_47).slideUp("slow",function(){
Compilation.undo(id,"q");
$(this).removeClass("deleted_quote");
_48.render_quote({elem:_47,view:"view"});
$(this).show("slow");
});
},_do_heading:function(_4a,_4b){
var _4c,id,_4e;
id=$(_4a).attr("id");
_4c=$.trim(window.getSelection().toString());
if(_4c===""){
this.publish("warning",{msg:"You did not select any text for setting the heading"});
return;
}
_4e=_4b.replace("heading_","");
Compilation.update_heading({id:id,heading:_4c,action:_4e});
},process_verse:function(_4f){
var _50;
_50=$.trim(window.getSelection().toString()).split(/\r?\n/);
_50=$.map(_50,function(_51,i){
if(_51!==""){
return _51;
}
});
Quote.request_verse(_4f,_50);
this.display_verses();
},_do_section:function(_53,_54){
var _55,id,_57,_58;
_55=$(_53).parents("div.quote");
id=_55.attr("id");
link=_55.attr("link");
if(_54=="trans"){
_58="Translation";
...
if(_54=="trans_purport"){
_58="Translation and Purport";
}
Compilation.update_q_section(id,link,{section:_58});
},tips_handler:function(_59){
var _5a,_5b;
_5a=this;
_5b=$(_59).parents("div.quote");
if(/section/.test(_59.id)){
this.tip_alert({elem:_5b,type:"section"});
}
if(_59.id==="set_insert_tip"){
this.insert_new_quote(_5b);
}
if(_59.id==="edit_quote_tip"){
this.edit_quote(_5b);
}
if(_59.id==="edit_heading_tip"||_59.id==="set_heading_tip"){
this.tip_alert({elem:_5b,type:"edit_heading"});
}
},tip_alert:function(_5c){
var _5d,_5e;
_5d=this;
_5e=this._find_alert_tip_elem(_5c.elem);
if(!_5e){
return;
}
if(_5c.type==="heading"){
...
if(_5c.type==="edit_heading"){
this.message="Set heading:";
}
this.render({to:_5e,action:_5c.type});
if($(_5e).is(":hidden")){
$(_5e).siblings(".tips").slideUp("fast");
$(_5e).slideDown("fast");
}
QuotesController.enable_keybindings(this);
},cancel_tip:function(_5f){
if(!_5f){
if(window.console){
console.log("Error in QuoteController.cancel_tip: missing elem argument");
}
}
if($(_5f).hasClass("edit_quote")||$(_5f).parents(".edit_quote").length){
return;
}
var _60;
$(document).unbind("click");
_60=this._find_alert_tip_elem(_5f);
if($(_60).is(":visible")){
$(_60).slideUp("slow");
if($(_60).siblings(".tips")){
$(_60).siblings(".tips").slideDown("slow");
}
}
},insert_new_quote:function(_61){
Compilation.insert_new_quote($(_61).attr("id"),$(_61).attr("link"),{type:"quote"},"q");
},_find_alert_tip_elem:function(_62){
var p,tip;
if($(_62).hasClass("quote")){
p=_62;
}else{
p=$(_62).parents("div.quote");
}
tip=$("div#alert_tip",p).get(0);
return tip;
},bind_escape:function(_65){
...
},_append_quote:function(_67){
var _68;
this.quote=_67;
_68=this.quote.parent?this.quote.parent.replace(/[.,()]/g,""):"compilation";
if(window.console){
console.info("QuotesController#_append_quote: appending "+_67.id+" to "+_68);
}
if($("#"+_68).length){
this.render({bottom:_68,action:"new_quote"});
}else{
if(window.console){
console.error("QuotesController#_append_quote: error rendering "+_67.id+" to "+_68);
}
this.publish("report_error",{msg:"Error rendering "+_67.id+" to "+_68});
return;
}
},hi_terms:function(_69){
var _6a;
_6a=Facts.db.terms;
if(!_6a){
if(window.console){
...
$.each(_6a,function(i,_6c){
if(_6c===""){
return true;
}
$(_69).highlight_sanskrit(_6c);
});
},update:function(_6d){
var id,_6f,_70;
id=$(_6d).attr("id");
_6f={};
$.each(["heading","trans","purport"],function(i,_72){
_6f[_72]=_73(_72);
});
function _73(_74){
if($(_6d).children("#"+_74).length){
var val=$.trim($(_6d).children("#"+_74).val());
return val!==""?val:false;
}else{
return false;
}
};
if($(_6d).children("#text").length){
_6f["text"]=$(_6d).children("#text").val();
}
_70=$("#fix_link_input",_6d);
if($(_70).is(":visible")&&$(_70).val()!==""){
var _76;
_76=$("#fix_link_input",_6d).val();
$(_6d).attr("link",_76).removeAttr("link_text").removeAttr("parent").removeAttr("book");
if(window.console){
console.info("QuotesController#update: fixing link to: "+_76);
}
this.publish("changed_link",{elem:_6d});
return;
}
Compilation.update_db(id,_6f,"q");
return;
},insert_prabhupada_speaker:function(_77){
if(_77.selectionStart||_77.selectionStart=="0"){
var _78=_77.selectionStart;
var _79=_77.selectionEnd;
_77.value=_77.value.substring(0,_78)+"Prabhup&#257;da: "+_77.value.substring(_79,_77.value.length);
}
},insert_diacritic:function(_7a,_7b){
if(_7a.selectionStart||_7a.selectionStart=="0"){
var _7c=_7a.selectionStart;
var _7d=_7a.selectionEnd;
_7a.value=_7a.value.substring(0,_7c)+_7b+_7a.value.substring(_7d,_7a.value.length);
_7a.setSelectionRange(_7d+1,_7d+1);
_7a.focus();
}
},_transition_hilite:function(_7e,_7f,_80){
var w,q,_83,off;
$(_7e).css("background-color",_7f);
setTimeout(function(){
$(_7e).css("background-color","");
},_80+"000");
w=window.innerHeight;
q=$(_7e).height();
_83=w-q;
off=_83<=0?-50:-_83/2;
$.scrollTo($(_7e),"fast",{easing:"easeOutElastic",offset:off});
...
$(".verse").dialog({dialogClass:"verse_dialog",buttons:{"Yes":_86,"No":_87}});
}
},"rendered subscribe":function(_88){
var _89;
_89=this;
if($(_88).hasClass("deleted_quote")||$(_88).hasClass("edit_quote")){
return;
}
_8a(_88);
_8b(_88);
_8c(_88);
_8d(_88);
this.hi_terms($(_88).children(".text"));
function _8a(_8e){
$(".text",_8e).each(function(){
var _8f,_90;
_8f=$(this).html();
_8f=_8f.replace(/^:(.+?)$/mg,"<dd>$1</dd>");
_90=_8f.match(/(<dd>.+?<\/dd>\n?)+/g);
if(_90){
$.each(_90,function(i,_92){
var re=new RegExp("(.+?\\n+)"+RegExp.escape(_92),"g");
_8f=_8f.replace(re,function(all,_95){
return _95.indexOf("<dl class=\"verse_in_q\">")>-1?all:_95+"<dl class=\"verse_in_q\">\n"+_92+"</dl>\n";
});
});
}
$(this).html(_8f);
...
function _8c(_98){
$(".text",_98).each(function(){
var _99;
_99=$(this).html();
_99=_99.replace(/^.+$/mg,_9a);
function _9a(all){
if(/<\/?d(d|l)/.test(all)){
return all;
}else{
...
},"compilation.updated subscribe":function(_a3){
var _a4,id,_a6;
_a4=this;
id=_a3.id;
_a6=$("#"+id);
_a4.render_quote({elem:_a6,view:"view"});
if(!_a6.hasClass("building_quote")){
_a6.addClass("q_updated").removeClass("q_new");
_a4._transition_hilite($("#"+id),"#DCBFF1",5);
}
},"compilation.deleted subscribe":function(_a7){
var _a8,_a9;
_a8=this;
_a9="#"+_a7.id;
$(_a9).slideUp("slow",function(){
_a8.render_quote({elem:_a9,view:"delete"});
$(this).fadeIn("slow");
});
},"compilation.quote_inserted subscribe":function(_aa){
var _ab,_ac;
_ab=this;
_ac=$("#"+_aa.id);
_ac.fadeOut("fast",function(){
_ab.render_quote({elem:_ac,view:"view"});
$(this).removeClass("building_quote").fadeIn("medium");
});
this._transition_hilite(_ac,"#EEF7D9",5);
},"compilation.new_quote subscribe":function(_ad){
var _ae=this;
this.render_quote({elem:_ad.elem,id:_ad.elem.id,view:"view"});
if(!CompileController.loading){
$("#"+_ad.elem.id).parents(".sub_section").children(".quote").tsort({attr:"index"});
$.scrollTo("#"+_ad.elem.id+".q_new","slow",{easing:"easeOutExpo",offset:-50,onAfter:_ae.display_verses});
}
},"compilation.section_checked subscribe":function(_af){
var id,_b1;
id=_af.id;
_b1=_af.result;
if(_b1==="bad"){
...
},"quote.created subscribe":function(_b2){
Compilation.add_to_db(_b2,_b2.id,_b2.parent,"q");
},"quote.verse_request subscribe":function(_b3){
this.verse=_b3.verse;
this.id=_b3.id;
this.quote=_b3.quote;
this.render({bottom:"verses",action:"verse"});
},"quote.found_reference subscribe":function(_b4){
_b4.text=CompileFormController.temp_quote;
q=new Quote(_b4);
},"changed_link subscribe":function(_b5){
if(window.console){
console.info("In QuotesController.changed_link observer");
}
var _b6=_b5.elem;
this.render_quote({elem:_b6,view:"view"});
Compilation.del_from_db($(_b6).attr("id"),"q");
q=new Quote(_b6);
}});
;
include.set_path('controllers');
...
var _d,re,_f,_10,_11,_12,_13;
_d=this;
_f=_c["text"];
_11=_d.extract_veda_ref(_f);
if(_11){
_13={};
_12=$.trim(_11.text.replace(/^[a-z]/,_14));
this.Class.temp_quote=_12;
_13["ref"]=_c["ref"]?_c["ref"]:_11.ref;
_13["ref"]=_13["ref"].replace(/\s+/g," ");
_c["ref"]?_13["type"]="title":"";
Quote.find_reference(_13);
}else{
...
},"quote.not_found_reference subscribe":function(_1a){
if($("#compile_tools #ref_lookup").is(":hidden")){
$("#compile_tools #ref_lookup #ref").html("Search for link for this quote and click submit.<br/>Orig ref. was: <b>"+_1a.ref+"</b>");
$("#compile_tools #ref_lookup").show();
}
},"quote.title_req_failed subscribe":function(_1b){
this.publish("warning",{msg:_1b.msg});
},"quote.ajax subscribe":function(_1c){
if(_1c.type==="start"){
$("#ajax").show();
}
if(_1c.type==="end"){
...
var _3;
if(e.originalTarget.type==="text"||e.altKey){
return;
}
...
if($("#"+_1b).length===0){
if(window.console){
console.error("Error in FactsController.append: "+_1b+" does not exist in dom");
}
return;
}
this.render({bottom:_1b,action:"append"});
css=_19.index%2?{background:"#DEE2F9"}:{background:"#D4D9F9"};
$("#"+this.id).css(css);
...
$(".quote .text").highlight_sanskrit(_1c);
},un_hilite:function(_1d){
if(!_1d){
if(window.console){
console.log("term missing in FactsController.un_hilite "+_1d);
}
return;
}
var v,re;
re=new RegExp("<span class=\"highlight_terms\">"+_1d+"</span>","g");
$(".quote .text").each(function(){
v=$(this).html().replace(re,_1d);
$(this).html(v);
});
},editable:function(id){
var _21,_22;
_22=this;
_21=id?"#"+id:".term, #goal, .categories, #notes";
$(_21).editable(function(_23,_24){
return _22.update(this,_23);
},{event:"dblclick",type:"text",style:"border: solid 0px indigo;"});
},_render_facts:function(_25){
var _26,_27;
_26=this;
this.facts=_25;
$("#facts").length?_27={to:"facts",action:"facts"}:_27={bottom:"compile_tools",action:"facts"};
this.render(_27);
$(document).ready(function(){
_26.attach_events();
});
...
this.editable();
},reset_input:function(_29){
var _2a;
$(_29).css({color:"#D2C1F2","font-size":"","font-weight":""});
_2a=$(_29.parentNode).attr("fact")==="terms"?"expressions":$(_29.parentNode).attr("fact");
_29.value="Add new "+_2a+"...";
},color_list:function(_2b){
_2b.filter(":even").css({background:"#D4D9F9"}).end().filter(":odd").css({background:"#DEE2F9"});
},checkbox:function(_2c){
var _2d,_2e;
_2d=_2c.id.replace(/complete_/,"");
_2e=_2c.checked?"add":"del";
Facts.complete(_2d,_2e);
...
},"facts.created subscribe":function(_2f){
var _30;
_30=this;
this._render_facts(_2f.facts);
...
_30.color_list($(".categories"));
}});
},"facts.added subscribe":function(_31){
this.append(_31);
},"facts.deleted subscribe":function(_32){
var _33;
_33="#"+_32.fact+"_"+_32.index;
if(_32.fact==="terms"){
this.un_hilite(_32.old);
}
$(_33).remove();
},"facts.totals_updated subscribe":function(_34){
this.update_t_b_sections_view();
this.update_totals_view();
},"facts.updated_term subscribe":function(_35){
this.hilite(_35.term);
},"quote.created subscribe":function(_36){
Facts.update_totals(_36);
},"compilation.deleted subscribe":function(_37){
Facts.update_totals(_37);
},"compilation.undone subscribe":function(_38){
Facts.update_totals(_38);
}});
;
