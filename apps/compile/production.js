...
include.resources("jquery.min","jquery.tinysort.min","jquery.autogrow","jquery.easing","jquery.scrollTo","jquery.jeditable","jquery.hoverIntent","jquery-autocomplete/jquery.autocomplete","jquery-ui-1.7.2.custom.min","BaltoUni.min","UniToASCII","jquery.highlight_sanskrit","RegExp.escape");
include.engines();
...
if(!(!e||!e.length||!i)){
c.support={leadingWhitespace:d.firstChild.nodeType===3,tbody:!d.getElementsByTagName("tbody").length,htmlSerialize:!!d.getElementsByTagName("link").length,style:/red/.test(i.getAttribute("style")),hrefNormalized:i.getAttribute("href")==="/a",opacity:/^0.55$/.test(i.style.opacity),cssFloat:!!i.style.cssFloat,checkOn:d.getElementsByTagName("input")[0].value==="on",optSelected:r.createElement("select").appendChild(r.createElement("option")).selected,checkClone:false,scriptEval:false,noCloneEvent:true,boxModel:null};
...
return a;
},guid:100000000,proxy:c.proxy,special:{ready:{setup:c.bindReady,teardown:c.noop},live:{add:function(a,b){
c.extend(a,b||{});
...
b==="live"?c(this.context).bind(oa(i,this.selector),{data:f,selector:this.selector,live:i},e):c(this.context).unbind(oa(i,this.selector),e?{guid:e.guid+this.selector+i}:null);
}
return this;
};
});
...
if(h){
u=l?{expr:p.pop(),set:A(l)}:o.find(p.pop(),p.length===1&&(p[0]==="~"||p[0]==="+")&&h.parentNode?h.parentNode:h,M);
...
var m=o.selectors={order:["ID","NAME","TAG"],match:{ID:/#((?:[\w\u00c0-\uFFFF-]|\\.)+)/,CLASS:/\.((?:[\w\u00c0-\uFFFF-]|\\.)+)/,NAME:/\[name=['"]*((?:[\w\u00c0-\uFFFF-]|\\.)+)['"]*\]/,ATTR:/\[\s*((?:[\w\u00c0-\uFFFF-]|\\.)+)\s*(?:(\S?=)\s*(['"]*)(.*?)\3|)\s*\]/,TAG:/^((?:[\w\u00c0-\uFFFF\*-]|\\.)+)/,CHILD:/:(only|nth|last|first)-child(?:\((even|odd|[\dn+-]*)\))?/,POS:/:(nth|eq|gt|lt|first|last|even|odd)(?:\((\d*)\))?(?=[^-]|$)/,PSEUDO:/:((?:[\w\u00c0-\uFFFF-]|\\.)+)(?:\((['"]?)((?:\([^\)]+\)|[^\(\)]*)+)\2\))?/},leftMatch:{},attrMap:{"class":"className","for":"htmlFor"},attrHandle:{href:function(g){
...
if(m.match.POS.test(g[0])||m.match.CHILD.test(g[0])){
return true;
}
}
return g;
...
if("sourceIndex" in r.documentElement){
C=function(g,h){
...
if(typeof a==="string"&&!/<script/i.test(a)&&(c.support.leadingWhitespace||!V.test(a))&&!F[(Ha.exec(a)||["",""])[1].toLowerCase()]){
a=a.replace(Ga,Ia);
try{
for(var b=0,d=this.length;b<d;b++){
...
if(!E&&w&&(w.readyState===4||q==="timeout")){
E=true;
w.onreadystatechange=c.noop;
...
include.set_path('models');
﻿;
Quote=MVC.Model.extend("quote",{attr:["id","parent","book","heading","link","link_text","text","trans","purport","index","type","tips","verses","bad_link","qod"],tips_db:{section:{title:"set Section",desc:"...this quote requires a section. Click here or press S",id:"set_section_tip"},edit_section:{title:"edit Section",desc:"...by clicking here or press S",id:"edit_section_tip"},heading:{title:"set hEading",desc:"...by highlighting a part of the quote and click here or press E",id:"set_heading_tip"},edit_heading:{title:"edit hEading",desc:"...by highlighting a part of the quote and click here or press E",id:"edit_heading_tip"},edit_quote:{title:"edit Quote",desc:"...by doubleClicking on it, clicking here or pressing Q",id:"edit_quote_tip"},insert_new:{title:"inseRt!",desc:"...this quote to the compilation by clicking here or press R",id:"set_insert_tip"}},link_text_db:{"NOD":"Nectar of Devotion","ISO":"Sri Isopanisad","TLC":"Teachings of Lord Caitanya, Chapter","RTW":"Renunciation Through Wisdom","NOI":"Nectar of Instruction","KB":"Krsna Book","EJ":"Easy Journey to Other Planets","LOB":"Light of the Bhagavata","MOG":"Message of Godhead","NBS":"Narada Bhakti Sutra","MM":"Mukunda-mala-stotra mantra"},cache:{},find_reference:function(_1){
var _2,_3,_4,_5;
_2=this;
_3={};
_4=false;
...
var _d,_e;
_d=this;
_d.update_progressbar(5,"Fetching compilation...");
...
_d.update_progressbar(5,"Bulding compilation...");
if(_e===""){
...
$("div#bodyContent > div#compilation > div#compile_tools_menu").hoverIntent(_18.Class.compile_tools_menu_hover_options);
...
},_render_section:function(_19){
var _1a;
this.section=_19;
_1a=this.section.parent;
if(window.console){
console.assert(_1a);
}
if(_1a!=="compilation"&&$("#"+_1a).length!==1){
this._render_section(Compilation.find_in_db(_1a,"s"));
}
if(window.console){
console.info("CompileController#_render_section: rendering "+this.section.id+" to "+_1a);
}
this.render({bottom:_1a,action:"sections"});
this.sort_section(_1a);
},clean_up:function(){
this._sort_sections();
this._remove_empty_secs();
this._sort_quotes();
},sort_section:function(_1b){
if($("div#compilation > div#"+_1b).children().length>1){
$("div#compilation > div#"+_1b).children("div.section, div.sub_section").tsort({attr:"sec_index"});
}
},_sort_sections:function(){
var _1c=$("div#compilation > div.section");
var _1d=$("div#compilation > div.section > div.sub_section");
$(_1c).tsort({attr:"sec_index"});
$(_1d).tsort({attr:"sec_index"});
},_remove_empty_secs:function(){
var _1e,id;
_1e=[];
_20($("div#compilation > div.section > div.sub_section"));
_20($("div#compilation > div.section"));
function _20(_21){
$(_21).each(function(){
id=$(this).attr("id");
$.inArray(id,_1e)>-1?_22(this):_1e.push(id);
...
function _22(_23){
if(window.console){
console.info("CompilationController#_remove_empty_secs: removing duplicate or empty section: "+$(_23).attr("id"));
}
$(_23).remove();
Compilation.del_from_db($(_23).attr("id"),"s");
};
...
_27();
function _28(_29){
_26=wgServer+wgScriptPath+"/api.php?action=login&format=json&"+_29;
$.ajax({type:"POST",url:_26,dataType:"json",success:function(_2a){
if(window.console){
console.dir(_2a);
}
$("body > div#progressbar").progressbar("enable");
_25.save();
},error:function(_2b,_2c,_2d){
if(window.console){
...
_28($("#login_form form").serialize());
};
function _27(){
if(!$("#login_form").hasClass("ui-dialog-content")){
$("#login_form").dialog({modal:true,title:"Log-in to save",modal:true,open:function(_2f,ui){
$("#login_form #lgpassword").focus();
},buttons:{"Login":_2e}}).keydown(function(e){
if(e.keyCode===13){
_2e();
}
});
...
var _32;
_32=this;
_32.publish("progressbar",{text:"Begin saving..."});
_32.check_user_loggedin();
},check_internet_connection:function(){
var _33,_34,_35;
_33=this;
_34=false;
_35=new XMLHttpRequest();
_35.onreadystatechange=_36;
_35.open("HEAD","http://www.google.com",true);
_35.send(null);
setTimeout(function(){
if(_35.readyState==4&&!_34){
_37();
}
},3000);
function _36(){
if(window.console){
console.log(_35.readyState);
}
if(_35.readyState==4){
if(_35.statusText&&_35.statusText!=""){
if(window.console){
console.log("Connected");
}
_34=true;
_33.publish("progressbar_hide");
_33.publish("connection_error",{ajax:_35,msg:"Vaniquotes server is unreachable, please wait a minute and try again."});
}
}
};
function _37(){
_33.publish("progressbar_hide");
_33.publish("connection_error",{ajax:_35,msg:"You appear to be offline! Check your internet connection and try again."});
};
},check_user_loggedin:function(){
var _38,_39;
_38=this;
_39=false;
sajax_do_call("isUserLoggedIn",[],_3a);
setTimeout(function(){
if(!_39){
if(navigator.platform=="MacIntel"){
_38.check_internet_connection();
}else{
_38.publish("progressbar_hide");
_38.publish("connection_error",{ajax:{},msg:"Vaniquotes server is unreachable, please wait a minute and try to save again."});
}
}
},3000);
function _3a(_3b){
_39=true;
if(_3b.status!=200){
_38.publish("connection_error",{ajax:_3b,msg:"Vaniquotes server is unreachable, please wait a minute and try to save again."});
}else{
if(window.console){
console.log("Success: "+_3b.responseText);
}
}
if(_3b.responseText==="no"){
_38.relogin();
}else{
_38._check_before_save();
}
};
},_check_before_save:function(){
var _3c;
_3c=this;
_3c.update_progressbar(0,"Checking compilation before save...");
function _3d(){
_3c.publish("progressbar_hide");
};
...
var _3e,_3f,_40,_41,_42,_43,_44,_45;
_3e=this;
this.Class.saving=true;
_43=$("<div id=\"compilation\"></div>");
_3e.update_progressbar(0,"Saving facts...");
_3f=Facts.save();
_3e.update_progressbar();
$("<div id=\"facts\">"+_3f+"</div>").appendTo(_43);
_3e.update_progressbar(0,"Saving quotes...");
_42=$(".quote").not(".deleted_quote").clone();
_45=40/_42.length;
if(window.console){
console.log("q_count is "+_42.length+", cur_progress is "+CompileController.progress_val+", progress_unit is "+_45);
}
_42.each(function(){
var q,p,l,lt,_4a;
q=$(this);
...
q.removeAttr("style");
_3e.update_progressbar(_45);
});
_42.appendTo(_43);
_3e.update_progressbar(0,"Saving sections and subsections...");
_41=$(".sub_section").clone();
_40=$(".section").clone();
_45=10/_41.length;
if(window.console){
console.log("subs_count is "+_41.length+", cur_progress is "+CompileController.progress_val+", progress_unit is "+_45);
}
_41.each(_4b);
_45=10/_40.length;
if(window.console){
console.log("sections_count is "+_40.length+", cur_progress is "+CompileController.progress_val+", progress_unit is "+_45);
}
_40.each(_4b);
function _4b(){
var s,l,h,id,_50;
...
$("div[parent=\""+id+"\"]:first",_43).before(s);
_3e.update_progressbar(_45);
};
_44=_43.wrap("<div></div>").parent("div").html().replace(/^\s+/mg,"").replace(/<\/span>\n/g,"</span>").replace(/(<div[^>]+?(?:id="facts"|class="(?:quote|section|sub_section)"))/g,"\n$1").replace(/([^\n])<\/div>/g,"$1\n</div>");
_3e.update_progressbar(0,"Finished processing compilation for save..");
$("#wpTextbox1").val(_44);
_3e.update_progressbar();
if(window.console){
console.log(_3f);
...
},update_progressbar:function(val,_59){
var _5a;
_5a=this;
_5a.Class.progress_val=val===undefined||val==0?_5a.Class.progress_val+2:_5a.Class.progress_val+val;
if(_59){
$("body > div#progressbar > div").text(_59);
}
CompileController.progressbar.progressbar("value",_5a.Class.progress_val);
if(window.console){
console.log("Updating progressbar to "+_5a.Class.progress_val+", status: "+_59);
}
},block_background:function(_5b){
var _5c;
_5c=this;
if(window.console){
console.info("In Compilation_controller.block_background with action: "+_5b);
}
if(_5b){
CompileController.fix_z_indexes(true);
...
},connection_error:function(_5d){
var _5e;
_5e=this;
if(window.console){
console.log("Ajax error: "+_5d.ajax.text+" : "+_5d.ajax.error);
}
window.alert(_5d.msg);
...
var _61,_62;
_61=83;
if(e.ctrlKey&&e.shiftKey&&e.keyCode===_61){
e.stopPropagation();
_5f.save();
}
});
...
this.clean_up();
this._loading("end");
},"quote.found_reference subscribe":function(_64){
...
},"compilation.quote_inserted subscribe":function(_65){
CompileController.show_compile_tools();
},"section.created subscribe":function(_66){
Compilation.add_to_db(_66,_66.id,_66.parent,"s");
this._render_section(_66);
},"hide_compile_tools subscribe":function(){
CompileController.hide_compile_tools();
},"info subscribe":function(_67){
if(window.console){
console.info("Info: "+_67.msg);
}
this.info(_67.msg);
},"warning subscribe":function(_68){
if(window.console){
console.log("Warning: "+_68.msg);
}
this.warning(_68.msg);
},"quote.warning subscribe":function(_69){
if(window.console){
console.log("Warning: "+_69.msg);
}
this.warning(_69.msg);
},"facts.warning subscribe":function(_6a){
if(window.console){
console.log("Warning: "+_6a.msg);
}
this.warning(_6a.msg);
},"compilation.warning subscribe":function(_6b){
if(window.console){
console.log("Warning: "+_6b.msg);
}
this.warning(_6b.msg);
},"section.warning subscribe":function(_6c){
if(window.console){
console.log("Warning: "+_6c.msg);
}
this.warning(_6c.msg);
},"report_error subscribe":function(_6d){
if(window.console){
console.log("Reporting error to developers/maintainers: "+_6d.msg);
}
this.report_error(_6d.msg);
},"connection_error subscribe":function(_6e){
this.connection_error(_6e);
},"quote.connection_error subscribe":function(_6f){
this.connection_error(_6f);
},"progressbar subscribe":function(_70){
var _71;
_71=this;
_71.block_background(true);
if(window.console){
...
$("body > div#progressbar > div").text(_70.text);
},"progressbar_hide subscribe":function(_72){
...
_73.block_background(false);
_73.Class.progress_val=0;
},"progressbar_update subscribe":function(_74){
if(window.console){
console.count("Progressbar_update subscribe");
}
status=_74.status?_74.status:false;
this.update_progressbar(_74.val,status);
},"compilation.progressbar_update subscribe":function(_75){
if(window.console){
console.count("Progressbar_update subscribe from Compilation");
}
status=_75.status?_75.status:false;
this.update_progressbar(_75.val,status);
},"facts.progressbar_update subscribe":function(_76){
if(window.console){
console.count("Progressbar_update subscribe from Facts");
}
status=_76.status?_76.status:false;
this.update_progressbar(_76.val,status);
},"quote.check_internet_connection subscribe":function(_77){
this.check_internet_connection(_77);
}});
;
include.set_path('controllers');
QuotesController=MVC.Controller.extend("quotes",{currently_editing:false,focused_textarea:false,current_quote:"",key:{escape:27,heading:69,section:83,trans:84,purport:80,trans_purport:78,edit_quote:81,insert:82,heading_create:65,heading_edit:77,heading_set:69,heading_append:68,heading_new:78,verse_select:86,enter:13},enable_keybindings:function(_1){
...
_8=$("div#alert_tip").is(":visible")?$("div.q_menu > div.q_tips > div#alert_tip",q):$("div.q_menu > div.q_tips",q);
k=e.keyCode;
...
$.each(QuotesController.key,function(_9,_a){
if(_a===e.keyCode){
$("input[id*=\""+_9+"\"]",_8).click();
return false;
}
});
...
},insert_prabhupada_speaker:function(_e){
if(_e.selectionStart||_e.selectionStart=="0"){
var _f=_e.selectionStart;
var _10=_e.selectionEnd;
_e.value=_e.value.substring(0,_f)+"Prabhup&#257;da: "+_e.value.substring(_10,_e.value.length);
}
},},{mouseover:function(_11){
_11.event.kill();
QuotesController.current_quote=_11.element;
if(!$(_11.element).hasClass("edit_quote")){
QuotesController.enable_keybindings(this);
}
},mouseleave:function(_12){
_12.event.kill();
QuotesController.disable_keybindings();
this.cancel_tip(_12.element);
},dblclick:function(_13){
if(_13.element.has_class("edit_quote")!==undefined){
return;
}
_13.event.kill();
...
this.render_quote({elem:_13.element,view:"edit"});
},"div#edit_buttons input#Update_quote click":function(_14){
var _15;
_15=$(_14.element).parents(".quote");
_14.event.kill();
this._event_resp({elem:_15,action:"update"});
},"div#edit_buttons input#Cancel_quote click":function(_16){
var _17;
_17=$(_16.element).parents(".quote");
_16.event.kill();
this._event_resp({elem:_17,action:"cancel"});
},"div#link_text click":function(_18){
_18.event.kill();
$(_18.element).parents("div.edit_quote").children("div#fix_link").toggle().children("input#fix_link_input").focus();
},"span#prabhupada_icon click":function(_19){
var _1a;
_19.event.kill();
_1a=$(_19.element).parents(".quote").children("#text")[0];
if(_1a.value.length===_1a.selectionStart){
this.publish("warning",{msg:"You must place the cursor in the text where Prabhup&#257;da is the speaker"});
return;
}
QuotesController.insert_prabhupada_speaker(_1a);
},"div#diacritics span#diacritics_toggle click":function(_1b){
$(_1b.element).siblings("p").toggle();
},"div#diacritics p a click":function(_1c){
var _1d,_1e;
_1c.event.kill();
_1d=this.Class.focused_textarea;
if(!_1d){
this.publish("warning",{msg:"You must place the cursor in the text where you wish to insert the diacritic character"});
return;
}
diacritc=_1c.element.innerHTML;
this.insert_diacritic(_1d,diacritc);
},"textarea focus":function(_1f){
this.Class.focused_textarea=_1f.element;
},"div.undo_quote click":function(_20){
if(_20.element.has_class("edit_quote")!==undefined){
return;
}
var _21;
_20.event.kill();
_21=$(_20.element).parents("div.quote");
this.undo(_21);
},"div.del_quote click":function(_22){
var _23;
_22.event.kill();
_23=$(_22.element).parents("div.quote");
this.delete_quote(_23);
},"div.candidate_quote click":function(_24){
var _25;
_24.event.kill();
$(_24.element).hasClass("ui-state-error")?$(_24.element).removeClass("ui-state-error"):$(_24.element).addClass("ui-state-error");
},".deleted_quote_msg .undo_del_quote click":function(_26){
var _27;
_26.event.kill();
_27=$(_26.element).parents("div.quote");
this.undo(_27);
},"div.text mouseup":function(_28){
if(window.getSelection().toString()===""){
return;
}
if(_28.element.has_class("edit_quote")!==undefined){
return;
}
_28.event.kill();
var _29;
_29=_28.element;
this.check_selection(_29);
},"div.q_menu div.q_tips input.tips click":function(_2a){
var _2b;
_2b=_2a.element;
_2a.event.kill();
this.tips_handler(_2b);
},"div.q_menu div.q_tips div#alert_tip input.alert_tip_heading_or_verse click":function(_2c){
var id,_2e;
_2c.event.kill();
id=_2c.element.id;
_2e=$(_2c.element).parents("div.quote");
if(id==="heading_select"){
if(_2e.children(".heading").length){
this.tip_alert({elem:_2e,type:"heading"});
}else{
this._do_heading(_2e,"heading_set");
}
}else{
this.process_verse($(_2e).attr("id"));
}
},"div.q_menu div.q_tips div#alert_tip input.alert_tip_heading_set click":function(_2f){
var id,_31;
_2f.event.kill();
id=_2f.element.id;
_31=$(_2f.element).parents("div.quote");
if(id==="heading_new"){
Compilation.update_heading({id:_31.attr("id"),heading:" ",action:"new"});
$("#heading",_31).focus();
}
if(id==="heading_edit"){
if(this.Class.currently_editing){
...
if(_31.children(".heading").length===0){
Compilation.update_heading({id:_31.attr("id"),heading:" ",action:"new"});
}else{
this.render_quote({elem:_31,view:"edit"});
}
$("#heading",_31).focus().select();
}
if(id==="heading_create"){
this.tip_alert({elem:_31,type:"heading"});
}
if(id==="heading_set"||id==="heading_append"){
this._do_heading(_31,id);
}
},"div.q_menu div.q_tips div#alert_tip input click":function(_32){
var _33,_34;
_32.event.kill();
_34=_32.element;
_33=_34.id;
if(window.console){
console.log(_34+" with "+_33);
}
this._do_section(_34,_33);
},".ui-state-default mouseover":function(_35){
$(_35.element).addClass("ui-state-hover");
},".ui-state-default mouseout":function(_36){
$(_36.element).removeClass("ui-state-hover");
},".ui-state-default mousedown":function(_37){
$(_37.element).addClass("ui-state-active");
},".ui-state-default mouseup":function(_38){
$(_38.element).removeClass("ui-state-active");
},render_quote:function(_39){
var id,_3b,_3c;
_3b=_39["elem"];
_3b.id?id=_3b.id:id=$(_3b).attr("id");
if($("#"+id).length!==1){
this._append_quote(_3b);
}
if(_39["view"]==="view"){
_3c="quote";
...
if(_39["view"]==="edit"){
_3c="quote_edit";
this.Class.currently_editing={elem:_3b,view:"view"};
$("#"+id).addClass("edit_quote");
$(document).unbind("click");
CompileController.disable_keybindings();
QuotesController.enable_edit_keybindings(_3b);
}else{
if(_39["view"]==="delete"){
_3c="delete";
...
_3c==="delete"?this.deleted=Compilation.db.find(id,"d"):this.quote=Compilation.db.find(id,"q");
if(_3c==="quote"&&this.quote.section==="Translation and Purport"&&(this.quote.trans===" "||this.quote.purport===" ")){
this.render_quote({elem:_3b,view:"edit"});
return;
}
if(_3c==="quote"&&this.quote.heading===" "){
this.render_quote({elem:_3b,view:"edit"});
return;
}
if(_39["view"]==="edit"){
...
},edit_quote:function(_3d){
if(this.Class.currently_editing){
this.render_quote(this.Class.currently_editing);
}
this.render_quote({elem:_3d,view:"edit"});
$.scrollTo(_3d,"slow",{easing:"easeOutExpo",offset:-50});
},_event_resp:function(_3e){
var _3f,id,_41;
_41=this;
_3f=$(_3e.elem);
id=_3f.attr("id");
action=_3e.action;
if(_3f.children("#trans, #purport").length===2&&action==="cancel"){
if(/^\s+$/.test(_3f.children("#trans").val())||/^\s+$/.test(_3f.children("#purport").val())){
action="update";
}
}
if(_3f.children("#heading").length===1&&action==="cancel"){
if(/^\s+$/.test(_3f.children("#heading").val())){
action="update";
}
}
if(action==="update"){
...
_3f.fadeOut("fast");
this.render_quote({elem:_3f,view:"view"});
_3f.fadeIn("slow");
if(!_3f.hasClass("building_quote")){
this._transition_hilite(_3f,"#FFFEC6",2);
}
}
QuotesController.disable_edit_keybindings(_3e.elem);
},check_selection:function(_42){
var q=$(_42).parents(".quote");
if($("div#alert_tip",q).is(":visible")){
return;
}
var _44,_45,_46,_47;
_44=this;
_45=$.trim(window.getSelection().toString());
if(_45===""){
...
_46=$(_42).parents("div.quote");
this.tip_alert({elem:_46,type:"heading_or_verse"});
},delete_quote:function(_48){
var id,_4a;
_4a=this;
id=$(_48).attr("id");
...
_4c=this;
id=$(_4b).attr("id");
$(_4b).slideUp("slow",function(){
Compilation.undo(id,"q");
$(this).removeClass("deleted_quote");
_4c.render_quote({elem:_4b,view:"view"});
$(this).show("slow");
});
},_do_heading:function(_4e,_4f){
var _50,id,_52;
id=$(_4e).attr("id");
_50=$.trim(window.getSelection().toString());
if(_50===""){
this.publish("warning",{msg:"You did not select any text for setting the heading"});
return;
}
_52=_4f.replace("heading_","");
Compilation.update_heading({id:id,heading:_50,action:_52});
},process_verse:function(_53){
var _54;
_54=$.trim(window.getSelection().toString()).split(/\r?\n/);
_54=$.map(_54,function(_55,i){
if(_55!==""){
return _55;
}
});
Quote.request_verse(_53,_54);
this.display_verses();
},_do_section:function(_57,_58){
var _59,id,_5b,_5c;
_59=$(_57).parents("div.quote");
id=_59.attr("id");
link=_59.attr("link");
if(_58=="trans"){
_5c="Translation";
...
if(_58=="trans_purport"){
_5c="Translation and Purport";
}
Compilation.update_q_section(id,link,{section:_5c});
},tips_handler:function(_5d){
var _5e,_5f;
_5e=this;
_5f=$(_5d).parents("div.quote");
if(/section/.test(_5d.id)){
this.tip_alert({elem:_5f,type:"section"});
}
if(_5d.id==="set_insert_tip"){
this.insert_new_quote(_5f);
}
if(_5d.id==="edit_quote_tip"){
this.edit_quote(_5f);
}
if(_5d.id==="edit_heading_tip"||_5d.id==="set_heading_tip"){
this.tip_alert({elem:_5f,type:"edit_heading"});
}
},tip_alert:function(_60){
var _61,_62;
_61=this;
_62=this._find_alert_tip_elem(_60.elem);
if(!_62){
return;
}
if(_60.type==="heading"){
...
if(_60.type==="edit_heading"){
this.message="Set heading:";
}
this.render({to:_62,action:_60.type});
if($(_62).is(":hidden")){
$(_62).siblings(".tips").slideUp("fast");
$(_62).slideDown("fast");
}
},cancel_tip:function(_63){
if(!_63){
if(window.console){
console.log("Error in QuoteController.cancel_tip: missing elem argument");
}
}
if($(_63).hasClass("edit_quote")||$(_63).parents("div.edit_quote").length){
return;
}
var _64;
_64=this._find_alert_tip_elem(_63);
if($(_64).is(":visible")){
$(_64).slideUp("slow");
if($(_64).siblings(".tips")){
$(_64).siblings(".tips").slideDown("slow");
}
}
},insert_new_quote:function(_65){
Compilation.insert_new_quote($(_65).attr("id"),$(_65).attr("link"),{type:"quote"},"q");
},_find_alert_tip_elem:function(_66){
var p,tip;
if($(_66).hasClass("quote")){
p=_66;
}else{
p=$(_66).parents("div.quote");
}
tip=$("div#alert_tip",p).get(0);
return tip;
},bind_escape:function(_69){
...
},_append_quote:function(_6b){
var _6c;
this.quote=_6b;
_6c=this.quote.parent?this.quote.parent.replace(/[.,()]/g,""):"compilation";
if(window.console){
console.info("QuotesController#_append_quote: appending "+_6b.id+" to "+_6c);
}
if($("#"+_6c).length){
this.render({bottom:_6c,action:"new_quote"});
}else{
if(window.console){
console.error("QuotesController#_append_quote: error rendering "+_6b.id+" to "+_6c);
}
this.publish("report_error",{msg:"Error rendering "+_6b.id+" to "+_6c});
return;
}
},hi_terms:function(_6d){
var _6e;
_6e=Facts.db.terms;
if(!_6e){
if(window.console){
...
$.each(_6e,function(i,_70){
if(_70===""){
return true;
}
$(_6d).highlight_sanskrit(_70);
});
},update:function(_71){
var id,_73,_74;
id=$(_71).attr("id");
_73={};
$.each(["heading","trans","purport"],function(i,_76){
_73[_76]=_77(_76);
});
function _77(_78){
if($(_71).children("#"+_78).length){
var val=$.trim($(_71).children("#"+_78).val());
return val!==""?val:false;
}else{
return false;
}
};
if($(_71).children("#text").length){
_73["text"]=$(_71).children("#text").val();
}
_74=$("#fix_link_input",_71);
if($(_74).is(":visible")&&$(_74).val()!==""){
var _7a;
_7a=$("#fix_link_input",_71).val();
$(_71).attr("link",_7a).removeAttr("link_text").removeAttr("parent").removeAttr("book");
if(window.console){
console.info("QuotesController#update: fixing link to: "+_7a);
}
this.publish("changed_link",{elem:_71});
return;
}
Compilation.update_db(id,_73,"q");
return;
},insert_diacritic:function(_7b,_7c){
if(_7b.selectionStart||_7b.selectionStart=="0"){
var _7d=_7b.selectionStart;
var _7e=_7b.selectionEnd;
_7b.value=_7b.value.substring(0,_7d)+_7c+_7b.value.substring(_7e,_7b.value.length);
_7b.setSelectionRange(_7e+1,_7e+1);
_7b.focus();
}
},_transition_hilite:function(_7f,_80,_81){
var w,q,_84,off;
$(_7f).css("background-color",_80);
setTimeout(function(){
$(_7f).css("background-color","");
},_81+"000");
w=window.innerHeight;
q=$(_7f).height();
_84=w-q;
off=_84<=0?-50:-_84/2;
$.scrollTo($(_7f),"fast",{easing:"easeOutElastic",offset:off});
...
$(".verse").dialog({dialogClass:"verse_dialog",buttons:{"Yes":_87,"No":_88}});
}
},"rendered subscribe":function(_89){
var _8a;
_8a=this;
if($(_89).hasClass("deleted_quote")||$(_89).hasClass("edit_quote")){
return;
}
_8b(_89);
_8c(_89);
_8d(_89);
_8e(_89);
this.hi_terms($(_89).children(".text"));
function _8b(_8f){
$(".text",_8f).each(function(){
var _90,_91;
_90=$(this).html();
_90=_90.replace(/^:(.+?)$/mg,"<dd>$1</dd>");
_91=_90.match(/(<dd>.+?<\/dd>\n?)+/g);
if(_91){
$.each(_91,function(i,_93){
var re=new RegExp("(.+?\\n+)"+RegExp.escape(_93),"g");
_90=_90.replace(re,function(all,_96){
return _96.indexOf("<dl class=\"verse_in_q\">")>-1?all:_96+"<dl class=\"verse_in_q\">\n"+_93+"</dl>\n";
});
});
}
$(this).html(_90);
...
},"compilation.updated subscribe":function(_a4){
var _a5,id,_a7;
_a5=this;
id=_a4.id;
_a7=$("#"+id);
_a5.render_quote({elem:_a7,view:"view"});
if(!_a7.hasClass("building_quote")){
_a7.addClass("q_updated").removeClass("q_new");
_a5._transition_hilite($("#"+id),"#DCBFF1",5);
}
},"compilation.deleted subscribe":function(_a8){
var _a9,_aa;
_a9=this;
_aa="#"+_a8.id;
$(_aa).slideUp("slow",function(){
_a9.render_quote({elem:_aa,view:"delete"});
$(this).fadeIn("slow");
});
},"compilation.quote_inserted subscribe":function(_ab){
var _ac,_ad;
_ac=this;
_ad=$("#"+_ab.id);
_ad.fadeOut("fast",function(){
_ac.render_quote({elem:_ad,view:"view"});
$(this).removeClass("building_quote").fadeIn("medium");
});
this._transition_hilite(_ad,"#EEF7D9",5);
},"compilation.new_quote subscribe":function(_ae){
var _af=this;
this.render_quote({elem:_ae.elem,id:_ae.elem.id,view:"view"});
if(!CompileController.loading){
$("#"+_ae.elem.id).parents(".sub_section").children(".quote").tsort({attr:"index"});
$.scrollTo("#"+_ae.elem.id+".q_new","slow",{easing:"easeOutExpo",offset:-50,onAfter:_af.display_verses});
}
},"compilation.section_checked subscribe":function(_b0){
var id,_b2;
id=_b0.id;
_b2=_b0.result;
if(_b2==="bad"){
...
},"quote.created subscribe":function(_b3){
Compilation.add_to_db(_b3,_b3.id,_b3.parent,"q");
},"quote.verse_request subscribe":function(_b4){
this.verse=_b4.verse;
this.id=_b4.id;
this.quote=_b4.quote;
this.render({bottom:"verses",action:"verse"});
},"quote.found_reference subscribe":function(_b5){
_b5.text=CompileFormController.temp_quote;
q=new Quote(_b5);
},"changed_link subscribe":function(_b6){
if(window.console){
console.info("In QuotesController.changed_link observer");
}
var _b7=_b6.elem;
this.render_quote({elem:_b7,view:"view"});
Compilation.del_from_db($(_b7).attr("id"),"q");
q=new Quote(_b7);
}});
;
include.set_path('controllers');
...
var _3;
if(e.originalTarget.type==="text"||e.altKey||e.ctrlKey){
return;
}
