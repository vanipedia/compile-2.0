 ...
 *
 */
CompileController = MVC.Controller.extend('compilation', /* @Static */ {
  progress_val: 0,
  loading: false,
  saving: false,
  compile_tools: '',
  ...
  link_autocomplete: function(elem, fixed) {
    ...
    $(elem).autocomplete({
			source: function(request, response) {
				$.get("/php/get_vanisource_title.php",
     		{
					q: request.term,
	        type: 'title',
	        suggest: true
  ...
  _loading: function(now) {
    ...
    if (now === 'init') {
      ...
      that.publish('progressbar', {
        text: 'Loading Compilation...'
      });
  ...
  attach_events: function() {
    ...
    CompileController.compile_tools.tabs().draggable({
      handle: '> ul'
    });
    ...
    $('div#compilation > div#compile_tools > #compile_help #theme_switcher > .jlthemeswitcher-opener').jlthemeswitcher({
      ...
      themes: [
        ["Vaniquotes", "/js/compile-2.0/stylesheets/skins/vaniquotes/images/theme_30_ui_vaniquotes.png", "/js/compile-2.0/stylesheets/skins/vaniquotes/jquery-ui.css"],
        ["UI Lightness", "http://static.jquery.com/ui/themeroller/images/themeGallery/theme_30_ui_light.png", "http://ajax.googleapis.com/ajax/libs/jqueryui/1.7.2/themes/ui-lightness/jquery-ui.css"],
        ["UI Darkness", "http://static.jquery.com/ui/themeroller/images/themeGallery/theme_30_ui_dark.png", "http://ajax.googleapis.com/ajax/libs/jqueryui/1.7.2/themes/ui-darkness/jquery-ui.css"],
        ["Smoothness", "http://static.jquery.com/ui/themeroller/images/themeGallery/theme_30_smoothness.png", "http://ajax.googleapis.com/ajax/libs/jqueryui/1.7.2/themes/smoothness/jquery-ui.css"],
        ["Start", "http://static.jquery.com/ui/themeroller/images/themeGallery/theme_30_start_menu.png", "http://ajax.googleapis.com/ajax/libs/jqueryui/1.7.2/themes/start/jquery-ui.css"],
        ["Redmond", "http://static.jquery.com/ui/themeroller/images/themeGallery/theme_30_windoze.png", "http://ajax.googleapis.com/ajax/libs/jqueryui/1.7.2/themes/redmond/jquery-ui.css"],
        ["Sunny", "http://static.jquery.com/ui/themeroller/images/themeGallery/theme_30_sunny.png", "http://ajax.googleapis.com/ajax/libs/jqueryui/1.7.2/themes/sunny/jquery-ui.css"],
        ["Overcast", "http://static.jquery.com/ui/themeroller/images/themeGallery/theme_30_overcast.png", "http://ajax.googleapis.com/ajax/libs/jqueryui/1.7.2/themes/overcast/jquery-ui.css"],
        ["Le Frog", "http://static.jquery.com/ui/themeroller/images/themeGallery/theme_30_le_frog.png", "http://ajax.googleapis.com/ajax/libs/jqueryui/1.7.2/themes/le-frog/jquery-ui.css"],
        ["Flick", "http://static.jquery.com/ui/themeroller/images/themeGallery/theme_30_flick.png", "http://ajax.googleapis.com/ajax/libs/jqueryui/1.7.2/themes/flick/jquery-ui.css"],
        ["Pepper Grinder", "http://static.jquery.com/ui/themeroller/images/themeGallery/theme_30_pepper_grinder.png", "http://ajax.googleapis.com/ajax/libs/jqueryui/1.7.2/themes/pepper-grinder/jquery-ui.css"],
        ["Eggplant", "http://static.jquery.com/ui/themeroller/images/themeGallery/theme_30_eggplant.png", "http://ajax.googleapis.com/ajax/libs/jqueryui/1.7.2/themes/eggplant/jquery-ui.css"],
        ["Dark Hive", "http://static.jquery.com/ui/themeroller/images/themeGallery/theme_30_dark_hive.png", "http://ajax.googleapis.com/ajax/libs/jqueryui/1.7.2/themes/dark-hive/jquery-ui.css"],
        ["Cupertino", "http://static.jquery.com/ui/themeroller/images/themeGallery/theme_30_cupertino.png", "http://ajax.googleapis.com/ajax/libs/jqueryui/1.7.2/themes/cupertino/jquery-ui.css"],
        ["South St", "http://static.jquery.com/ui/themeroller/images/themeGallery/theme_30_south_street.png", "http://ajax.googleapis.com/ajax/libs/jqueryui/1.7.2/themes/south-street/jquery-ui.css"],
        ["Blitzer", "http://static.jquery.com/ui/themeroller/images/themeGallery/theme_30_blitzer.png", "http://ajax.googleapis.com/ajax/libs/jqueryui/1.7.2/themes/blitzer/jquery-ui.css"],
        ["Humanity", "http://static.jquery.com/ui/themeroller/images/themeGallery/theme_30_humanity.png", "http://ajax.googleapis.com/ajax/libs/jqueryui/1.7.2/themes/humanity/jquery-ui.css"],
        ["Hot Sneaks", "http://static.jquery.com/ui/themeroller/images/themeGallery/theme_30_hot_sneaks.png", "http://ajax.googleapis.com/ajax/libs/jqueryui/1.7.2/themes/hot-sneaks/jquery-ui.css"],
        ["Excite Bike", "http://static.jquery.com/ui/themeroller/images/themeGallery/theme_30_excite_bike.png", "http://ajax.googleapis.com/ajax/libs/jqueryui/1.7.2/themes/excite-bike/jquery-ui.css"],
        ["Vader", "http://static.jquery.com/ui/themeroller/images/themeGallery/theme_30_black_matte.png", "http://ajax.googleapis.com/ajax/libs/jqueryui/1.7.2/themes/vader/jquery-ui.css"],
        ["Dot Luv", "http://static.jquery.com/ui/themeroller/images/themeGallery/theme_30_dot_luv.png", "http://ajax.googleapis.com/ajax/libs/jqueryui/1.7.2/themes/dot-luv/jquery-ui.css"],
        ["Mint Choc", "http://static.jquery.com/ui/themeroller/images/themeGallery/theme_30_mint_choco.png", "http://ajax.googleapis.com/ajax/libs/jqueryui/1.7.2/themes/mint-choc/jquery-ui.css"],
        ["Black Tie", "http://static.jquery.com/ui/themeroller/images/themeGallery/theme_30_black_tie.png", "http://ajax.googleapis.com/ajax/libs/jqueryui/1.7.2/themes/black-tie/jquery-ui.css"],
        ["Trontastic", "http://static.jquery.com/ui/themeroller/images/themeGallery/theme_30_trontastic.png", "http://ajax.googleapis.com/ajax/libs/jqueryui/1.7.2/themes/trontastic/jquery-ui.css"],
        ["Swanky Purse", "http://static.jquery.com/ui/themeroller/images/themeGallery/theme_30_swanky_purse.png", "http://ajax.googleapis.com/ajax/libs/jqueryui/1.7.2/themes/swanky-purse/jquery-ui.css"]
      ],
    });
  ...
  _render_section: function(section) {
    ...
    if (window.console) {
      console.info('CompileController#_render_section: rendering ' + this.section.id + ' to ' + parent);
    }
    this.render({
      bottom: parent,
      action: 'sections'
  ...
  _remove_empty_secs: function() {
    ...
    function remove(elem) {
      if (window.console) {
        console.info('CompilationController#_remove_empty_secs: removing duplicate or empty section: ' + $(elem).attr('id'));
      }
      $(elem).remove();
  ...
  _sort_quotes: function() {
    $('div#bodyContent > div#compilation div.quote').tsort({
      attr: "index"
    });
  },
  ...
  check_internet_connection: function() {
    ...
    xmlReq.send(null);
    setTimeout(function() {
      if (xmlReq.readyState == 4 && !connected) {
        ajax_error();
      }
    }, 3000);
    function state_change() {
      ...
      if (xmlReq.readyState == 4) {
        if (xmlReq.statusText && xmlReq.statusText != "") {
          ...
          connected = true;
          that.publish('progressbar_hide');
          that.publish('connection_error', {
            ajax: xmlReq,
            msg: 'Vaniquotes server is unreachable, please wait a minute and try again.'
          });
        }
      }
    }
    ...
    setTimeout(function() {
      if (!resp) {
        if (navigator.platform == 'MacIntel') {
          ...
          that.publish('connection_error', {
            ajax: {},
            msg: 'Vaniquotes server is unreachable, please wait a minute and try to save again.'
          });
        }
      }
    }, 3000);
...
/*if(window.console) {
  ...
  connection_error: function(params) {
    ...
    that = this;
    if (window.console) {
      console.log('Ajax error: ' + params.ajax.text + ' : ' + params.ajax.error);
    }
  ...
  "info subscribe": function(params) {
    if (window.console) {
      console.info('Info: ' + params.msg);
    }
    this.info(params.msg);
  },
  "warning subscribe": function(params) {
    if (window.console) {
      console.log('Warning: ' + params.msg);
    }
  ...
  "report_error subscribe": function(params) {
    if (window.console) {
      console.log('Reporting error to developers/maintainers: ' + params.msg);
    }
  ...
  "progressbar subscribe": function(params) {
    ...
    CompileController.progressbar.progressbar({
      value: 0
    });
